...
# Determine how much etcd db grows due to loading RBAC users. No compress/defrag after the users are loaded.
# Usage: ./runRBAClusterSizeTestNoPost.sh <cluster name> <number of users>
